...
class IndexSignIn extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <div fluid="true" className="cont-foto-login">
          <Container fluid="true" className="centro-pa-entro">
            <Row className="imagen-new-login center text-center">
              ...
              <div className="center text-center">
                <Card className="card-login center">
                  <StepWizard>
                    <Step
                      title="¡Bienvenido!"
                      text="Vamos a crear tu cuenta, es fácil, rápido y seguro"
                    />
                    <Step
...
IndexSignIn = connect(mapStateToProps, mapDispatchToProps)(IndexSignIn);
IndexSignIn = withLastLocation(IndexSignIn);
