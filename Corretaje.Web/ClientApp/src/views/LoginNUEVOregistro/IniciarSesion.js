...
import { Row, Button, Navbar, Col, Container, Card } from "react-bootstrap";
    ...
    return (
      <Container fluid={true}>
        ...
        >
          ...
          <div className="text-center">
            <Card className="cuadradofinal center text-center s-margin">
              Si aún no eres parte de Propins selecciona tu perfil según lo que
              buscas haciendo{" "}
              <Link className="linkahome" to={"/"}>
                click aquí
              </Link>
            </Card>
            <div>
        ...
        <div id="login" className="hideWEB2">
          ...
          <Row className="center text-center">
            <Col className="center text-center">
              <Card className="cuadradofinal2 center text-center">
                Si aún no eres parte de Propins selecciona tu perfil según lo
                que buscas haciendo{" "}
                <Link className="linkahome" to={"/"}>
                  click aquí
                </Link>
...
const mapStateToProps = (state) => {
  ...
  return { ...auth, data: app.data, loading: app.loading };
};
